  ...
  <Modal :modelValue="isOpen" id="input">
    ...
    >
      ...
      <div class="relative">
        <component
          :is="iconComponent"
          class="absolute left-2 top-1/2 transform -translate-y-1/2 text-gray-600 dark:text-gray-400"
          :size="20"
        />
        <input
          v-model="inputValue"
          ...
          class="w-full p-1 pl-8 md:pl-10 bg-transparent border-b-[1px] border-gray-600 dark:border-gray-400 outline-none placeholder:text-gray-500"
        />
      </div>
      <span
        v-if="showCharCount"
