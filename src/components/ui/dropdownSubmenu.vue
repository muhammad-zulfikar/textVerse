<template>
  <div class="text-sm cursor-pointer relative px-1">
    <span
      class="p-2 cursor-pointer w-full text-left rounded-md md:hover:bg-cream-200 md:dark:hover:bg-gray-700 active:bg-cream-200 active:dark:bg-gray-700 transition-colors duration-200 flex items-center whitespace-nowrap"
      :class="[
        itemType === 'normal' &&
    ...
    >
      ...
      <div
        ...
        class="absolute right-2 p-1 rounded-full md:hover:bg-cream-300 md:dark:hover:bg-gray-600 active:bg-cream-300 active:dark:bg-gray-600 transition-transform duration-200"
        :class="{
