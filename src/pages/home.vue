...
import { notesStore, folderStore, uiStore, authStore, localStore } from '@/utils/stores';
...
const loadNotes = async () => {
  try {
    ...
    if (authStore.isLoggedIn) {
      ...
      // Check if initial notes have never been loaded before
      if (notesStore.notes.length === 0 && !localStore.getInitialNotesLoaded()) {
        await notesStore.loadInitialNotes();
