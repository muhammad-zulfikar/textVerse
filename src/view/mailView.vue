    ...
    >
      ...
      >
        <div
          ...
          :class="[
            'list px-4 py-3 cursor-pointer hover:bg-cream-200 dark:hover:bg-gray-700',
            {
              'bg-cream-200 dark:bg-gray-700': actualSelectedNoteId === note.id,
        ...
        >
          ...
          >
            ...
            >
              <div
                class="flex items-center w-fit px-2 py-1 cursor-pointer truncate card hover:text-black dark:hover:text-white hover:bg-cream-200 dark:hover:bg-gray-700"
...
<script setup lang="ts">
  ...
  const hasChanges = computed(() => {
    ...
    return hasChanged(initialNote.value!, { ...editedNote.value });
  });
